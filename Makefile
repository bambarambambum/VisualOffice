# Environment
USER_NAME=androsovm
PROJECT_ID=docker-275315
MYSQL_USER=visualoffice
MYSQL_PASSWORD=VeryStrongPassword
MYSQL_DATABASE=visualoffice
############################
...
#get_mysql_pod:
#	export MYSQL_DATABASE=$(kubectl get pod -o=jsonpath='{.items..metadata.name}' | awk '{print $1}' | grep mysql)
